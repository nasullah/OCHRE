...
<html>
    ...
    <body>
        ...
        <div id="show-trial" class="content scaffold-show" role="main">
            ...
            <f:display bean="trial" />
            <g:form resource="${this.trial}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.trial}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
